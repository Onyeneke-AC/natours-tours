...
const tourSchema = new mongoose.Schema(
  {
    name: {
      ...
      unique: true,
      trim: true,
      minlength: [10, 'A tour name must be greater than / equal to 10'],
      maxlength: [40, 'A tour name must be less than / equal to 40'],
...
// the middleware that embeds tour guides. Can work but not the best
...
// also called the pre and post hook
